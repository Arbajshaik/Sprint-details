...
public class ReadWriteController {
    ...
    public String sprintTracker(@RequestParam String lid, @RequestParam String sprintEmailid, @RequestParam String featureTeamName, @RequestParam String projectName, @RequestParam String sprintNumber) throws EncryptedDocumentException, InvalidFormatException {
    	File file = new File(Constants.FILE_NAME);
        logger.debug("lid"+ lid+" email");
    	try {
            if (file.exists()) {
